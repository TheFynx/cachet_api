...
describe CachetSubscribers do
  ...
  Subscribers = CachetSubscribers.new(api_key, base_url)
  ...
  describe '#CachetSubscribers' do
    ...
    subscribers_create_response = Subscribers.create(options_subscribe_create)
    ...
    subscribers_list_response = Subscribers.list
    ...
    subscribers_delete_response = Subscribers.delete(options_subscribe_delete)
